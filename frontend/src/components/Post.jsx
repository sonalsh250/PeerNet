...
const Post = ({ post }) => {
    ...
    const isOwner = authUser._id === post.author._id; //if we are the owner of this post
    const isLiked = post.likes.includes(authUser._id); //if we have already liked the post
            ...
            <div className='p-4'>
                ...
                <div className='flex justify-between text-info'>
                    ...
                    <PostAction
                        ...
                        text={`Comment (${comments.length || 0})`}
